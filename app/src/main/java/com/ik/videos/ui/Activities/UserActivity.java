...
import com.ik.videos.Adapters.UserAdapter;
...
import com.ik.videos.ui.fragement.UserFragment;
...
public class UserActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        bundle_video.putString("image", image);
        bundle_video.putString("name", name);
