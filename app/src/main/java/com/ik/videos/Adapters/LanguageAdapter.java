...
public class LanguageAdapter extends RecyclerView.Adapter implements SelectableViewHolder.OnItemSelectedListener {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        switch (step){
            case 1:
                holder.relative_layout_item_question_choice_global.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.bg_lang_1));

                break;
            case 2:
                holder.relative_layout_item_question_choice_global.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.bg_lang_2));
                break;
            case 3:
                holder.relative_layout_item_question_choice_global.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.bg_lang_3));
                break;
            case 4:
                holder.relative_layout_item_question_choice_global.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.bg_lang_4));
                break;
            case 5:
                holder.relative_layout_item_question_choice_global.setBackgroundDrawable(activity.getResources().getDrawable(R.drawable.bg_lang_5));
                break;
        }
