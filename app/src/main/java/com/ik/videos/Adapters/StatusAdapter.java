...
import com.ik.videos.ui.Activities.AllFullScreenUserActivity;
import com.ik.videos.ui.Activities.AllPortaitVideosActivity;
import com.ik.videos.ui.Activities.GifActivity;
import com.ik.videos.ui.Activities.ImageActivity;
...
//            Log.v("this is path",statusList.get(position).getPath());
    ...
    class DownloadFileFromURL extends AsyncTask<Object, String, String> {
        ...
        public void AddDownloadLocal(Integer position){
            final DownloadStorage downloadStorage= new DownloadStorage(activity.getApplicationContext());
            List<com.ik.videos.model.Status> download_list = downloadStorage.loadImagesFavorites();
            Boolean exist = false;
            ...
            if (exist  == false) {
                ArrayList<com.ik.videos.model.Status> audios= new ArrayList<com.ik.videos.model.Status>();
                for (int i = 0; i < download_list.size(); i++) {
                    audios.add(download_list.get(i));
                }
                com.ik.videos.model.Status videodownloaded = statusList.get(position);
