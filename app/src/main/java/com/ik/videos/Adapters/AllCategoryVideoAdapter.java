...
import com.ik.videos.ui.Activities.AllCategoryActivity;
import com.ik.videos.ui.Activities.CategoryActivity;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder,final int position) {
        ...
        switch (getItemViewType(position)) {
            case 1: {
                ...
                Picasso.with(activity.getApplicationContext()).load(categoryList.get(position).getImage()).error(R.drawable.placeholder).placeholder(R.drawable.placeholder).into(((CategoryHolder) holder).image_view_item_category);
